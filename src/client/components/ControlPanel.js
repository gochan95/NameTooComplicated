...
export default class ControlPanel extends Component {
  renderSlider = title => {
    return (
      <div
        key={title}
        className="control-panel-type-container border-no-padding"
      >
        <p className="medium-text title-padding-right">{title}</p>
        <input
          className="control-panel-slider-content medium-text"
          type="range"
        />
      </div>
    );
  ...
  renderButton = text => {
    return (
      <div key={text} className="control-panel-type-container border">
        <div className="control-panel-button" id="sphere-icon" />
  ...
  renderInput = title => {
    return (
      <div className="control-panel-type-container border">
        <p className="medium-text title-padding-right">{title}</p>
        <input
          className="control-panel-input-box"
  ...
  renderGroups = () => {
    ...
    return (
      <div className="control-panel-groups">
        <p className="large-text title-padding-left title-padding-right">
          {title}
        </p>
